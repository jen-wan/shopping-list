...
class ShoppingList {
  ...
  static makeShoppingList(rawShoppingList) {
    let shoppingList = Object.assign(new ShoppingList(), {
      id: rawShoppingList.id, 
      title: rawShoppingList.title,
    });

    rawShoppingList.items.forEach(item => shoppingList.add(Item.makeItem(item)));
    return shoppingList;
  }
